...
def main():
    ...
    sdf_file_path = os.path.join(get_package_share_directory("hospital_robot_spawner"), "models", "pioneer3at", "model.sdf")
    ...
    target_sdf_file_path = os.path.join(get_package_share_directory("hospital_robot_spawner"), "models", "Target", "model.sdf")
